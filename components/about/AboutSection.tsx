...
const AboutSection = ({ isMore }: AboutSectionProps) => {
        ...
        <div className=" flex-wrap flex items-center justify-between">
          ...
          <div data-aos="fade-right" className="md:w-[48%] w-full">
            ...
            <p className="text-[#ABB2BF] ">
              ...
              <br />
              <br />
              I’m a FULL STACK Developer Next Js based in zagora, morocco. I can
              develop responsive websites and raise them into modern
          ...
          <div data-aos="fade-left" className=" mx-auto">
            <Image src={MainUrl} alt="main image" width={300} height={900} />
